...
اكتملت **المراحل 0 إلى 4**: التأسيس، ثم قاعدة البيانات وسياسات عزل الفروع (RLS)، ثم المصادقة
والأدوار وهيكل التطبيق، ثم شاشات الإدارة العامة، ثم الشُعب والطلاب بكامل دورة القيد (تغيير شعبة،
نقل بين الفروع، أرشفة، استعادة) والاستيراد والتصدير. كل الفحوص خضراء: 186 اختباراً
(139 وحدة + 47 تكامل على PostgreSQL حقيقي) و 66 اختبار e2e على مقاسي سطح المكتب والهاتف.
المرحلة التالية: المعلمون.
